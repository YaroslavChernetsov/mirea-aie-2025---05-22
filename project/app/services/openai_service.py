...
- classify by the primary subject first: every SQL/database-query question must use sql, including tasks
  that ask to write a query; use coding only for non-SQL programming tasks
